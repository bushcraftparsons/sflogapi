...
func main() {
	...
	// with error handling
	// using TLS
	log.Fatal(http.ListenAndServeTLS(":8080", "/le_keys/keys/letsencrypt/fullchain.pem", "/le_keys/keys/letsencrypt/privkey.pem", handlers.CORS(originsOk, headersOk, methodsOk)(router))) //Launch the app, visit https://localhost:8080/api
}
